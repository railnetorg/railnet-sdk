export const wrapperVehicleFactoryAbi = [
  {
    type: 'constructor',
    inputs: [
      {
      ...
      {
        name: 'wrapperVehicleImplementation',
        type: 'address',
    ...
    inputs: [
      {
        name: 'params',
        type: 'tuple',
        internalType: 'struct WrapperVehicleFactory.SpawnParams',
        components: [
          {
            name: 'asset',
            type: 'address',
    ...
    outputs: [
      {
        name: 'vehicle',
        type: 'address',
        internalType: 'contract WrapperVehicle',
      },
    ],
    stateMutability: 'nonpayable',
  },
