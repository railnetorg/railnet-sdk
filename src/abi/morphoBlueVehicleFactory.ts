export const morphoBlueVehicleFactoryAbi = [
  {
    type: 'constructor',
    inputs: [
      {
      ...
      {
        name: 'morphoBlueVehicleImplementation',
        type: 'address',
    ...
    inputs: [
      {
        name: 'params',
        type: 'tuple',
        internalType: 'struct MorphoBlueVehicleFactory.SpawnParams',
        components: [
          {
            name: 'morpho',
            type: 'address',
    ...
    outputs: [
      {
        name: 'vehicle',
        type: 'address',
        internalType: 'contract MorphoBlueVehicle',
      },
    ],
    stateMutability: 'nonpayable',
  },
