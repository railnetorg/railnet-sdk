export const erc4626VehicleFactoryAbi = [
  {
    type: 'constructor',
    inputs: [
      {
    ...
    inputs: [
      {
        name: 'params',
        type: 'tuple',
        internalType: 'struct ERC4626VehicleFactory.SpawnParams',
        components: [
          {
            name: 'vault',
            type: 'address',
    ...
    outputs: [
      {
        name: 'vehicle',
        type: 'address',
        internalType: 'contract ERC4626Vehicle',
      },
    ],
    stateMutability: 'nonpayable',
  },
