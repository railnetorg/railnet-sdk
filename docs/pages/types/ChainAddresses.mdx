...
```ts
import type { ChainAddresses } from 'railnet-sdk'
```
...
### compoundV3VehicleFactory

- **Type:** `Address`

The factory contract for spawning Compound V3 vehicle instances.
...
The pre-deployed Aave V3 vehicle contract address.
