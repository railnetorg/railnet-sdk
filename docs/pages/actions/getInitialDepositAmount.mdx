...
Every factory spawn (`prepareSpawnConduit`, `prepareSpawnMultiVehicle`, `prepareSpawnAaveV3Vehicle`) pulls this amount
...
import { getAddresses, getInitialDepositAmount, prepareSpawnConduit } from '@railnetorg/railnet-sdk'
