...
[`randomSalt`](/utilities/randomSalt). Pass it explicitly to log the value and replay a failed
transaction. Required on [`prepareRedeemConduit`](/actions/preparedWrites), which stays pure.
