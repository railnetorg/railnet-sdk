...
:::info
This action automatically checks the conduit share allowance. If the current allowance is insufficient, it will send an **approval transaction** before the redeem, resulting in two transactions total.
:::
