...
import { base } from 'viem/chains'
import { getAddresses, spawnConduit, TransferMode } from 'railnet-sdk'
...
const { conduitFactory, usdc } = getAddresses(base.id)
...
```ts
import { getAddresses, isSupportedChain } from 'railnet-sdk'
